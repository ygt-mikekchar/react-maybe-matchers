...
/***/ function(module, exports, __webpack_require__) {
	...
	ComponentQuery = (function(superClass) {
	  ...
	  ComponentQuery.prototype.debug = function(callback) {
	    return this.bind((function(_this) {
	      return function(component) {
	        var messages, output;
...
/***/ function(module, exports, __webpack_require__) {
	...
	ComponentFilter = (function(superClass) {
	  ...
	  ComponentFilter.prototype.debug = function(callback) {
	    return this.bind((function(_this) {
	      return function(nodes) {
	        var messages, output;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React, ReactMaybeMatchers, ReactTestUtils;

	React = __webpack_require__(8);

	ReactTestUtils = __webpack_require__(165);

	ReactMaybeMatchers = __webpack_require__(1);

	describe("react maybe matchers", function() {
	  beforeEach(function() {
	    return new ReactMaybeMatchers(ReactTestUtils).addTo(jasmine);
	  });
	  return describe("ComponentQuery", function() {
	    describe("returning a single nodes", function() {
	      var CommentBox;
	      ...
	      beforeEach(function() {
	        return this.subject = ReactTestUtils.renderIntoDocument(React.createElement(CommentBox, null));
	      });
	      it("should find contained elements", function() {
	        return expect(this.subject).toBeAComponent(function(which) {
	          return which.contains.tags("div").result();
	        });
	      });
	      it("should not find elements that don't exist", function() {
	        return expect(this.subject).not.toBeAComponent(function(which) {
	          return which.contains.tags("a").result();
	        });
	      });
	      it("should allow debug", function() {
	        return expect(this.subject).toBeAComponent(function(which) {
	          return which.contains.tags("div").debug(function(nodes) {
	            return "This should fail";
	          }).result();
	        });
	      });
	      it("properly chains failing expressions", function() {
	        return expect(this.subject).not.toBeAComponent(function(which) {
	          return which.contains.tags("a")["with"].cssClass("pooh-bear").result();
	        });
	      });
	      it("should find elements with css class directly", function() {
	        return expect(this.subject).toBeAComponent(function(which) {
	          return which.contains.cssClass("commentBox").result();
	        });
	      });
	      return it("should find text in elements", function() {
	        return expect(this.subject).toBeAComponent(function(which) {
	          return which.contains.tags("div")["with"].cssClass("commentBox").text("Hello, world").result();
	        });
	      });
	    });
	    describe("returning multiple nodes", function() {
	      ...
	      CommentBox = React.createClass({
	        render: function() {
	          return React.createElement("div", {
	            "className": "commentBox"
	          }, React.createElement("span", null, "Hello, world!"), " ", React.createElement("span", null, "I am a comment box."));
	        }
	      });
	      beforeEach(function() {
	        return this.subject = ReactTestUtils.renderIntoDocument(React.createElement(CommentBox, null));
	      ...
	      it("should find contained elements", function() {
	        return expect(this.subject).toBeAComponent(function(which) {
	          return which.contains.tags("span").result();
	        });
	      });
	      it("should chain ComponentFilter on multiple nodes", function() {
	        return expect(this.subject).toBeAComponent(function(which) {
	          return which.contains.tags("span").exactly(2).times.result();
	        });
	      });
	      return it("should allow negative expectation on ComponentFilters", function() {
	        return expect(this.subject).not.toBeAComponent(function(which) {
	          return which.contains.tags("span").exactly(1).time.result();
	        });
	      });
	    });
	    return describe("returning react components", function() {
	      var CommentBox, CommentFrame, NotUsed;
	      CommentBox = React.createClass({
	        render: function() {
	          return React.createElement("div", {
	            "className": "commentBox"
	      ...
	      CommentFrame = React.createClass({
	        render: function() {
	          return React.createElement("div", null, React.createElement(CommentBox, null));
	        }
	      });
	      ...
	      beforeEach(function() {
	        return this.subject = ReactTestUtils.renderIntoDocument(React.createElement(CommentFrame, null));
	      });
	      it("should find contained components", function() {
	        return expect(this.subject).toBeAComponent(function(which) {
	          return which.contains.type(CommentBox).result();
	        });
	      });
	      return it("should not find components that don't exist", function() {
	        return expect(this.subject).not.toBeAComponent(function(which) {
	          return which.contains.type(NotUsed).result();
	        });
	      });
	    });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe("String#pluralize", function() {
	  it("does nothing for singular objects", function() {
	    return expect("one " + ('bucket'.pluralize(1))).toEqual("one bucket");
	  });
	  it("automatically adds an 's' to plural objects", function() {
	    return expect("five " + ('bucket'.pluralize(5))).toEqual("five buckets");
	  });
	  return describe("custom pluralization", function() {
	    it("pluralizes multiple objects", function() {
	      return expect("two " + ('mommy'.pluralize(2, 'mommies'))).toEqual("two mommies");
	    });
	    return it("does not not pluralize singular objects", function() {
	      return expect("there " + ('was'.pluralize(1, 'were')) + " one").toEqual("there was one");
	    });
	  });
	});
