...
/***/ function(module, exports, __webpack_require__) {
	...
	ComponentQuery = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	JasmineMonad = __webpack_require__(4);
	...
	ComponentQuery = (function(superClass) {
	  ...
	  function ComponentQuery(reactUtils, value1, util, testers, messages1) {
	    this.reactUtils = reactUtils;
	    this.value = value1;
	    this.util = util;
	  ...
	  ComponentQuery.prototype["return"] = function(value, messages) {
	    return new this.constructor(this.reactUtils, value, this.util, this.testers, messages);
	  };
	  ...
	  ComponentQuery.prototype.returnManyDom = function(nodes, messages) {
	  ...
	  ComponentQuery.prototype.tags = function(tag) {
	    return this.bind((function(_this) {
	      return function(component) {
	        ...
	        if (nodes.length > 0) {
	          return _this.returnManyDom(nodes, messages);
	        } else {
